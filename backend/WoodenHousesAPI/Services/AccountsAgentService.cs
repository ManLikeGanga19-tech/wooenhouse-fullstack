    ...
    ILogger<AccountsAgentService> log) : IAccountsAgentService
{
    ...
    private async Task SendWeeklyReportAsync(CancellationToken ct)
    {
        ...
        var adminUrl = config["Frontend:AdminUrl"] ?? "https://admin.woodenhouseskenya.com";
        var html = BuildReportHtml(now, weekStart,
            newContacts, agentReplied, quotesSent, quotesAccepted, quotesRejected,
            pendingQueue, agentTasksWeek, pipelineValue, acceptedValue, adminUrl);
    ...
    private static string BuildReportHtml(
        ...
        decimal pipelineValue, decimal acceptedValue, string adminUrl)
    {
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;">
                    ...
                    <tr><td align="center" style="padding:20px 0 0;">
                      <p style="margin:0;font-size:11px;color:#aaa;">
                        ...
                        <a href="{adminUrl}/dashboard/agents" style="color:#8B5E3C;">View agent activity</a>
                      </p>
                    </td></tr>
